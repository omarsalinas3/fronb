...
export class CitasComponent implements OnInit {
  ...
  medicos = [
    ...
    { id: 2, nombre: 'Dra. María García', hospital: 'Clínica Santa María', ciudad: 'San Miguel de Allende',
       especialidad: 'Pediatría', disponibilidad: 'Disponible', imagen: 'assets/Doctores/doctoraMariaGarcia.jpg' },
    ...
    { id: 17, nombre: 'Dr. Hernan Martínez', hospital: 'Hospital San Jose', ciudad: 'Dolores Hidalgo', 
      especialidad: 'Cirujano', disponibilidad: 'Disponible', imagen: 'assets/Doctores/doctorHernanMartinez.jpg' },
